...
![A screenshot showing the location of the _Link Account_ button](<../.gitbook/assets/image (42).png>)
...
![A screenshot showing the location of the _v_ button](<../.gitbook/assets/image (54).png>)
...
![A screenshot of the confirmation dialog box](<../.gitbook/assets/image (35).png>)
...
![A screenshot showing the location of the _Capabilities _ section](<../.gitbook/assets/image (37).png>)
...
![A screenshot of the _AWS CLI Instructions_ dialog box](<../.gitbook/assets/image (39).png>)
...
![A screenshot showing the location of the _AWS Account_ and _External ID_ values](<../.gitbook/assets/image (38).png>)
...
![A screenshot showing the location of the _Roles_ menu item](../.gitbook/assets/go-to-roles.png)
...
![A screenshot showing the _Options_ checkbox](../.gitbook/assets/account-and-external-id.png)
...
![A screenshot showing the location of the _Create policy_ button](../.gitbook/assets/create-policy-in-role.png)
...
![A screenshot of the _JSON_ tab](../.gitbook/assets/cleanshot-2021-06-09-at-15.12.51.jpg)
...
![A screenshot of the _Review policy_ screen](../.gitbook/assets/cleanshot-2021-06-09-at-15.11.55.jpg)
...
![A screenshot of the _JSON_ tab](<../.gitbook/assets/image (50).png>)
...
![A screenshot of the _Review policy_ screen](<../.gitbook/assets/image (48).png>)
...
!["`doit_intl_quotas` has been created"](<../.gitbook/assets/image (43).png>)
...
![A screenshot showing the location of the policy selection box](../.gitbook/assets/choose-policy.png)

Give the Role an identifiable name (ex. 'doit-intl-cmp-role'), review the selected policies, and click on "**Create role**".

![A screenshot of the _Create role_ screen](<../.gitbook/assets/image (41).png>)
...
![A screenshot of the _Create Role_form](<../.gitbook/assets/image (44) (1).png>)
...
![A screenshot showing the location of the _Status_ column](<../.gitbook/assets/image (53).png>)
...
![A screenshot showing the location of the _Unlink_ button](<../.gitbook/assets/image (46).png>)
...
![A screenshot showing the location of the _Edit_ button](<../.gitbook/assets/image (34).png>)

Then, check the box of any new feature(s) you'd like to add permissions for.

![A screenshot showing the location of the options button](<../.gitbook/assets/image (52).png>)
